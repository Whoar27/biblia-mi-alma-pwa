                ...
                <CardContent className="p-3">
                  <div className="relative mb-2">
                    <img 
                      src={plan.image} 
                      alt={plan.title}
                      className="w-full h-24 object-cover rounded-md bg-gradient-to-br from-biblical-purple-light to-biblical-blue-light"
                    />
                    {plan.isCompleted && (
                      <Badge className="absolute top-1 right-1 bg-biblical-green text-white text-xs">
                        <CheckCircle className="h-3 w-3 mr-1" />
                        Completado
                      </Badge>
                    )}
                    {plan.isRecent && !plan.isCompleted && (
                      <Badge className="absolute top-1 right-1 bg-biblical-orange text-white text-xs">
